<?php
	...
	if(isset($_POST['simpan'])){
		...
		$new_ktp = $_POST['new_ktp'];
		
		$kd_pasien = mysqli_real_escape_string($koneksi,$kd_pasien);
		$new_ktp = mysqli_real_escape_string($koneksi,$new_ktp);		
...
<html>
<head>
	<title>Kalbis Hospital - Pendaftaran Edit Nomor Identitas</title>
...
<body>
	...
	<div id="form">
		...
		<form action="" method="POST">
			...
			<div class="form-group">
				<label>Nomor Identitas Baru (16-digit):</label>
				<input type="text" class="form-control" name="new_ktp">
			</div>			
